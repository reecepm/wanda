...
import { RiArrowRightSLine, RiCheckLine } from '@/lib/icons'
...
function DropdownMenuContent({
  ...
  Pick<MenuPrimitive.Positioner.Props, 'align' | 'alignOffset' | 'side' | 'sideOffset'> & {
    /**
     * Element to portal the menu into. Default is `document.body`. Pass a ref
     * pointing inside a vaul `Drawer` (or any other body-pointer-events-locking
     * container) so clicks aren't trapped by the parent overlay.
     */
